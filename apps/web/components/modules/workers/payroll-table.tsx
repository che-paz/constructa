        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-end gap-2">
            ...
            <Button
              ...
              size="sm"
              onClick={() => shiftWeek(1)}
              disabled={payroll.week_start >= currentWeekStart}
            >
              Semana siguiente →
            </Button>
          </div>
              ...
              <tbody>
                {payroll.rows.map((row) => (
                  <tr key={row.worker_id} className="border-b last:border-0">
                    ...
                    {row.days.map((day) => (
                      <td key={day.work_date} className="px-1 py-2 text-center">
                    ...
                    <td className="px-3 py-2 text-right">{row.total_hours}h</td>
